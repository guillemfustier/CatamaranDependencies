...
static const _GetVelocity_Request_type_support_symbol_names_t _GetVelocity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetVelocity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, GetVelocity_Request)),
  }
};
...
get_message_type_support_handle<custom_interfaces::srv::GetVelocity_Request>()
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::GetVelocity_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, srv, GetVelocity_Request)() {
  return get_message_type_support_handle<custom_interfaces::srv::GetVelocity_Request>();
}
...
static const _GetVelocity_Response_type_support_symbol_names_t _GetVelocity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetVelocity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, GetVelocity_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_interfaces::srv::GetVelocity_Response>()
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::GetVelocity_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, srv, GetVelocity_Response)() {
  return get_message_type_support_handle<custom_interfaces::srv::GetVelocity_Response>();
}
...
static const _GetVelocity_type_support_symbol_names_t _GetVelocity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, GetVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, GetVelocity)),
  }
};
...
get_service_type_support_handle<custom_interfaces::srv::GetVelocity>()
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::GetVelocity_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, srv, GetVelocity)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<custom_interfaces::srv::GetVelocity>();
}
